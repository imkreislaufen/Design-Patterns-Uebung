 ...
 * 
 *         Diese Klasse stellt eine grafische Zählsteuerung bereit, die den
 *         Punktestand auf mehreren Displays verändern kann.
 */
public class Zaehlsteuerung extends JFrame {
	 ...
	 */
	public Zaehlsteuerung(final Display[] listDisp) {
